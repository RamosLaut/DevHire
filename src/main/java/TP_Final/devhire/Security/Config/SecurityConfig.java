...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain (HttpSecurity http) throws
        ...
        http.authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/company/name/*").hasAuthority("FILTER_COMPANIES")
                        ...
                        .requestMatchers("/company/delete/*").hasAuthority("DELETE_ACCOUNT")
                        ...
                        .requestMatchers("/dev/delete/*").hasAuthority("DELETE_ACCOUNT")
                        ...
                        .requestMatchers("/follow/followings/*/*").hasAuthority("READ_FOLLOWING")
                        .requestMatchers("/follow/ownFollowers").hasAuthority("READ_FOLLOWERS")
                        .requestMatchers("/follow/ownFollowings").hasAuthority("READ_FOLLOWING")
                        ...
                        .requestMatchers("/application/delete/*").hasAuthority("DELETE_APPLY")
                        ...
                        .requestMatchers("/api/stats").hasAuthority("GET_STATS")
